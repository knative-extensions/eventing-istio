...
func Get(ctx context.Context, selector string) v1beta1.WorkloadGroupInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch knative.dev/eventing-istio/pkg/client/istio/informers/externalversions/networking/v1beta1.WorkloadGroupInformer with selector %s from context.", selector)
	}
