...
func Get(ctx context.Context) v1beta1.SidecarInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/eventing-istio/pkg/client/istio/informers/externalversions/networking/v1beta1.SidecarInformer from context.")
	}
