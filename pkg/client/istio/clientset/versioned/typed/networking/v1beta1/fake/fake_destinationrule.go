...
func (c *FakeDestinationRules) UpdateStatus(ctx context.Context, destinationRule *v1beta1.DestinationRule, opts v1.UpdateOptions) (result *v1beta1.DestinationRule, err error) {
	emptyResult := &v1beta1.DestinationRule{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithOptions(destinationrulesResource, "status", c.ns, destinationRule, opts), emptyResult)
